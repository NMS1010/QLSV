...
namespace QLSV.Helpper
{
    public static class Utilities
    {
        ...
        public static void sendemaildev(string emailaddress, GiaoVien dev)
        {
            ...
            else
            {
                if (QLSV.Helpper.Utilities.IsValidEmail(emailaddress))
                {
                    ...
                    mess.Body += "<h1>Hello:" + dev.full_name + "</h1>";
                    ...
                    mess.Body += "<tbody>";
                    mess.Body += "<tr><td>" + dev.email + "</td>" + "<td>" + dev.password + "</td></tr>";
